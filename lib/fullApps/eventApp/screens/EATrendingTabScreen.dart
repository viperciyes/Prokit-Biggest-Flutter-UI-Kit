      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, i) {
          return Column(
              ...
              Stack(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: boxDecorationWithRoundedCorners(backgroundColor: primaryColor1, borderRadius:BorderRadius.only(bottomLeft: Radius.circular(8),bottomRight: Radius.circular(8),)),
            ...
            EAEventDetailScreen(name: forYouList[i].name!,hashTag: forYouList[i].hashtag! ,attending:forYouList[i].attending!,price:forYouList[i].price,image:forYouList[i].image!).launch(context,pageRouteAnimation: PageRouteAnimation.Slide);
          });
        },
      ),
    );
